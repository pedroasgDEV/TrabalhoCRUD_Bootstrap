<?php
  ...
  $id = $_GET['id'];
  $raca = $_POST['pesquisaDog'];
  $sql = "SELECT * FROM dog WHERE raca LIKE '%$raca%' ORDER BY nome ";
...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <a class="nav-link" href="userPerfil.php?id=<?php echo $id; ?>"></i><b>SEU PERFIL</b></i></a>
            <a class="nav-link" href="dogs.php?id=<?php echo $id; ?>"></i><b>CACHORROS</b></i></a>
            <a class="nav-link" href="../login.php"></i><b>SAIR</b></i></a>
            </ul> 
